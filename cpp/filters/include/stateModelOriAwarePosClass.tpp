...
stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::stateModelOriAwarePosClass(const int y_dim, const int x_dim, const std::string& def_file, const double radius, cv::Mat_<unsigned char> * const valid_mask)
...
// Default constructor
template <int TNClasses, size_t TOriModelIndex>
stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::stateModelOriAwarePosClass()
: stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::stateModelOriAwarePosClass(0,0,"",0.0,nullptr)
{
...
template <int TNClasses, size_t TOriModelIndex>
bool stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::readFromFile(const std::string& def_file)
{
...
template <int TNClasses, size_t TOriModelIndex>
void stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::setupHiddenProbs(const double hidden_time_constant)
{
...
void stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::initRandomParticle(TCombinedState& s)
{
...
void stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::step(std::vector<TCombinedState>& particles, const std::vector<TCombinedState>& origin_particles,
																	...
																	const cv::Mat_<cv::Vec2f>& /*motion*/, TReweightFunctor&& reweight_functor)
{
	...
	for(unsigned p = 0; p < n_particles; ++p)
	{
		...
		if(s.c != newclass)
		{
			const double ori = std::get<TOriModelIndex>(particles[p]).ori;
			...
			const Eigen::Rotation2D<double> rot_mat(ori);
...
template <int TNClasses, size_t TOriModelIndex>
template <typename TCombinedState, size_t TStateIndex>
statePosClass stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::meanEstimate(const std::vector<TCombinedState>& particles, const std::vector<double>& w) const
{
...
template <int TNClasses, size_t TOriModelIndex>
template <typename TCombinedState, size_t TStateIndex>
void stateModelOriAwarePosClass<TNClasses,TOriModelIndex>::meanShiftEstimate(statePosClass& estimate, const std::vector<TCombinedState>& particles, const std::vector<int>& kernel_indices_in, std::vector<int>& kernel_indices_out, const std::vector<double>& w, double& weight_out) const
{
	double weight_hidden = 0.0, weight_visible = 0.0;
